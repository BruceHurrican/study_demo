 ...
 * Use one of the various static methods for parsing SVGs by resource,
 * asset or input stream.
 ...
 * @see #getSVGFromString(String, int, int) (String)
    ...
    private static class SVGHandler extends DefaultHandler {
        ...
        public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
            ...
            if (localName.equals("svg")) {
                ...
                if ("none".equals(getStringAttr("display", atts)) && !hidden) {
                    hidden = true;
                    hiddenLevel = 1;
                    //Util.debug("Hidden up: " + hiddenLevel);
                }
                ...
                Logs.d(TAG, "UNRECOGNIZED SVG COMMAND: " + localName);
            }
        }
